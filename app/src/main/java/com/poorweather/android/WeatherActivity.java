...
import com.poorweather.android.service.AutoUpdateService;
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                SharedPreferences.Editor editor = getPreferences(WeatherActivity.MODE_PRIVATE).edit();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather != null && "ok".equals(weather.status)) {
                            SharedPreferences.Editor editor = getPreferences(WeatherActivity.this.MODE_PRIVATE).edit();
